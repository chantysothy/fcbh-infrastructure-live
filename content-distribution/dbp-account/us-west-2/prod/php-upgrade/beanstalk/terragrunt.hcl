...
inputs = {
  ...
  environment_description    = "DBP Production Beanstalk ALT"
  ...
  env_vars = {
    ...
    "S3_CONFIG_LOC"      = "https://s3-us-west-2.amazonaws.com/elasticbeanstalk-us-west-2-596282610570/dbp-alt"    
    "APP_ENV"            = "prod"
    ...
    "NEW_RELIC_APP_NAME" = "DBP4 PROD ALT"
  }
}
