...
dependency "dbp-web-newdata" {
  config_path = "../dbp-web-newdata"
  mock_outputs = {
...
inputs = {
  ...
  branch                             = "newdata-dev"
  force_destroy                      = true
  elastic_beanstalk_application_name = dependency.dbp-web-newdata.outputs.elastic_beanstalk_application_name
  elastic_beanstalk_environment_name = dependency.dbp-web-newdata.outputs.elastic_beanstalk_environment_name
}
