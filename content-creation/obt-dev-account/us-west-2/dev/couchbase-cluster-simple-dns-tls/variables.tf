...
variable "domain_name" {
  ...
  type        = string
  default = "biblebrain.com"
}
variable "load_balancer_certificate_arn" {
  description = "wildcard certificate associated with domain_name"
  type        = string
  default = "arn:aws:acm:us-west-2:121033846327:certificate/aaa1e110-84ae-47f3-9e1c-47d0b462f5bc"
}

variable "vpc_id" {
  description = "Existing VPC into which the resources will be created"
  type        = string
  default = "vpc-06986eb07fb0e9130"
}
variable "subnet_ids" {
  description = "Existing Subnet ids into which the resources will be created"
  type        = list(string)
  default = ["subnet-0b7cf87442034129f", "subnet-03c3494226c645d52"]
}
# ---------------------------------------------------------------------------------------------------------------------
# OPTIONAL PARAMETERS
